...
pkgdatadir = $(datadir)/gleecbtc
pkgincludedir = $(includedir)/gleecbtc
pkglibdir = $(libdir)/gleecbtc
pkglibexecdir = $(libexecdir)/gleecbtc
...
am__aclocal_m4_deps = $(top_srcdir)/build-aux/m4/ax_boost_base.m4 \
	...
	$(top_srcdir)/build-aux/m4/gleecbtc_find_bdb48.m4 \
	$(top_srcdir)/build-aux/m4/gleecbtc_qt.m4 \
	$(top_srcdir)/build-aux/m4/gleecbtc_subdir_to_include.m4 \
...
CONFIG_HEADER = $(top_builddir)/src/config/gleecbtc-config.h
CONFIG_CLEAN_FILES = libgleecbtcconsensus.pc share/setup.nsi \
...
am__DIST_COMMON = $(srcdir)/Makefile.in \
	$(srcdir)/libgleecbtcconsensus.pc.in \
...
CCACHE = /home/depends/x86_64-linux-gnu/share/../native/bin/ccache
...
CRYPTO_CFLAGS = -I/home/depends/x86_64-linux-gnu/include
CRYPTO_LIBS = -L/home/depends/x86_64-linux-gnu/lib -lcrypto -ldl
CXX = /home/depends/x86_64-linux-gnu/share/../native/bin/ccache g++ -m64 -std=c++11
...
EGREP = /bin/grep -E
ERROR_CXXFLAGS = 
EVENT_CFLAGS = -I/home/depends/x86_64-linux-gnu/include
EVENT_LIBS = -L/home/depends/x86_64-linux-gnu/lib -levent
EVENT_PTHREADS_CFLAGS = -pthread -I/home/depends/x86_64-linux-gnu/include
EVENT_PTHREADS_LIBS = -L/home/depends/x86_64-linux-gnu/lib -levent_pthreads -levent
EXEEXT = 
...
LDFLAGS = -L/home/depends/x86_64-linux-gnu/share/../lib 
LEVELDB_CPPFLAGS = 
...
OSX_INSTALLER_ICONS = $(top_srcdir)/src/qt/res/icons/gleecbtc.icns
...
WINDOWS_PACKAGING = $(top_srcdir)/share/pixmaps/gleecbtc.ico \
...
COVERAGE_INFO = baseline.info \
  test_gleecbtc_filtered.info total_coverage.info \
  baseline_filtered.info functional_test.info functional_test_filtered.info \
  test_gleecbtc_coverage.info test_gleecbtc.info

OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  $(OSX_APP)/Contents/Resources/gleecbtc.icns $(OSX_APP)/Contents/Info.plist \
  $(OSX_APP)/Contents/MacOS/GleecBTC-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
src/config/gleecbtc-config.h: src/config/stamp-h1
	@test -f $@ || rm -f src/config/stamp-h1
	@test -f $@ || $(MAKE) $(AM_MAKEFLAGS) src/config/stamp-h1

src/config/stamp-h1: $(top_srcdir)/src/config/gleecbtc-config.h.in $(top_builddir)/config.status
	@rm -f src/config/stamp-h1
	cd $(top_builddir) && $(SHELL) ./config.status src/config/gleecbtc-config.h
$(top_srcdir)/src/config/gleecbtc-config.h.in:  $(am__configure_deps) 
	($(am__cd) $(top_srcdir) && $(AUTOHEADER))
	rm -f src/config/stamp-h1
	touch $@

distclean-hdr:
	-rm -f src/config/gleecbtc-config.h src/config/stamp-h1
libgleecbtcconsensus.pc: $(top_builddir)/config.status $(srcdir)/libgleecbtcconsensus.pc.in
...
$(OSX_APP)/Contents/Resources/gleecbtc.icns: $(OSX_INSTALLER_ICONS)
	$(MKDIR_P) $(@D)
	$(INSTALL_DATA) $< $@
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/GleecBTC-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/GleecBTC-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
...
#test_gleecbtc.info: baseline_filtered.info
#	$(MAKE) -C src/ check
#	$(LCOV) -c $(LCOV_OPTS) -d $(abs_builddir)/src -t test_gleecbtc -o $@
#	$(LCOV) -z $(LCOV_OPTS) -d $(abs_builddir)/src

#test_gleecbtc_filtered.info: test_gleecbtc.info
#	$(abs_builddir)/contrib/filter-lcov.py $(LCOV_FILTER_PATTERN) $< $@
#	$(LCOV) -a $@ $(LCOV_OPTS) -o $@
...
#test_gleecbtc_coverage.info: baseline_filtered.info test_gleecbtc_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_gleecbtc_filtered.info -o $@

#total_coverage.info: test_gleecbtc_filtered.info functional_test_filtered.info
#	$(LCOV) -a $(LCOV_OPTS) baseline_filtered.info -a test_gleecbtc_filtered.info -a functional_test_filtered.info -o $@ | $(GREP) "\%" | $(AWK) '{ print substr($$3,2,50) "/" $$5 }' > coverage_percent.txt

#test_gleecbtc.coverage/.dirstamp:  test_gleecbtc_coverage.info
...
#cov: test_gleecbtc.coverage/.dirstamp total.coverage/.dirstamp
