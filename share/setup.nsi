...
!else
InstallDir $PROGRAMFILES\GleecBTC
!endif
CRCCheck on
XPStyle on
BrandingText " "
...
Section -post SEC0001
    ...
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\$(^Name).lnk" $INSTDIR\gleecbtc-qt
    CreateShortcut "$SMPROGRAMS\$StartMenuGroup\GleecBTC Core (testnet, -bit).lnk" "$INSTDIR\gleecbtc-qt" "-testnet" "$INSTDIR\gleecbtc-qt" 1
    ...
    WriteRegStr HKCR "gleecbtc" "URL Protocol" ""
    WriteRegStr HKCR "gleecbtc" "" "URL:GleecBTC"
    WriteRegStr HKCR "gleecbtc\DefaultIcon" "" $INSTDIR\gleecbtc-qt
    WriteRegStr HKCR "gleecbtc\shell\open\command" "" '"$INSTDIR\gleecbtc-qt" "%1"'
SectionEnd
...
Section /o -un.Main UNSEC0000
    Delete /REBOOTOK $INSTDIR\gleecbtc-qt
...
Section -un.post UNSEC0001
    ...
    Delete /REBOOTOK "$SMPROGRAMS\$StartMenuGroup\GleecBTC Core (testnet, -bit).lnk"
    Delete /REBOOTOK "$SMSTARTUP\GleecBTC.lnk"
